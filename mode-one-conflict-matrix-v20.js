...
(function exposeModeOneConflictMatrix(root, factory) {
  ...
  return Object.freeze({version:32,LEVELS,ALL_MASKS,analyseAlignment,evaluateConflictMatrix,generateConflictTrial,generateWarmupTrial,evaluateHistory,runAudit,installBrowser});
});